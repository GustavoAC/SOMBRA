...
Circle::Circle(const Point &_center, const int &_radius, const Pixel &_stroke_color)
    : m_center(_center), m_radius(_radius), stroke_color(_stroke_color) {}

Circle::Circle(const Point &_center, const int &_radius, const Pixel &_stroke_color, const Pixel &_fill_color)
    : m_center(_center), m_radius(_radius), stroke_color(_stroke_color), fill_color(std::make_shared<Pixel>(_fill_color)) {}
